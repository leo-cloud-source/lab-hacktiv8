...
# Page Configuration
st.set_page_config(
    page_title="NEXUS AI - Productivity Assistant",
    page_icon="⚡",
    layout="wide",
...
st.markdown('<p class="subtitle">Your Ultimate Productivity Assistant</p>', unsafe_allow_html=True)
...
if not google_api_key:
    ...
    with col2:
        ...
        <div class="feature-card">
            ...
            <p>Enter your API key to activate NEXUS AI and unlock unlimited productivity potential!</p>
        </div>
        """, unsafe_allow_html=True)
...
if ("agent" not in st.session_state) or (getattr(st.session_state, "_last_key", None) != google_api_key):
    try:
        with st.spinner("🔄 Initializing NEXUS AI..."):
            ...
            mode_prompts = {
                "💼 Task Manager": "You are NEXUS, an advanced AI productivity assistant specializing in task management. Help users organize, prioritize, and complete their tasks efficiently. Provide actionable advice and structured plans.",
                "📅 Schedule Optimizer": "You are NEXUS, an AI scheduling expert. Help users optimize their time, create efficient schedules, and balance work-life priorities.",
                "💡 Idea Generator": "You are NEXUS, a creative AI assistant. Help users brainstorm ideas, solve problems creatively, and think outside the box.",
                "📊 Goal Tracker": "You are NEXUS, an AI goal-setting coach. Help users set SMART goals, create action plans, and track progress effectively.",
                "🧠 Learning Assistant": "You are NEXUS, an AI learning companion. Help users learn new skills, understand concepts, and develop knowledge efficiently."
            }
...
if "messages" not in st.session_state:
    ...
    # Welcome message
    welcome_msg = f"🚀 **NEXUS AI ONLINE** - {assistant_mode} mode activated!\n\nHow can I boost your productivity today?"
...
with col2:
    st.markdown(
        '<p style="text-align: center; color: #00d4ff; font-family: Orbitron;">⚡ Powered by NEXUS AI Technology ⚡</p>',
        unsafe_allow_html=True
    )